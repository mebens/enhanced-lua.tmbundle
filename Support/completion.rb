...
@choices = [
  ...
  {d => 'love.draw', t => 'Callback function used to draw on the screen every frame.', i => '()'},
  {d => 'love.focus', t => 'Callback function triggered when window receives or loses focus.<br><strong>f</strong>:boolean = Window focus', i => '(f)'},
  {d => 'love.joystickpressed', t => 'Called when a joystick button is pressed.<br><strong>joystick</strong>:number = The joystick number, <strong>button</strong>:number = The button number', i => '(joystick, button)'},
